...
<head>
    ...
    <style>
        ...
        .details .bordered-container3 {
            ...
            margin-right: 100px; /* Adjust margin-right to move the container to the left */
            width: 274px; /* Set width to 150 pixels */
            height: 300px; /* Set height to 100 pixels */
            margin-top: 15px;
            padding: 5px 10px; /* Add padding */
            color: #B8B6B5;
            }
...
<body>
    <div class="container">
        <div class="image">
            <img src="https://g.christianbook.com/g/slideshow/5/514028/main/514028_1_ftc.jpg" alt="Book Cover">
        </div>
        <div class="details">
            <h2>Heidi</h2>
            <h3 style="color: red;">$14.50</h3> <!-- Adjusted price text color to red -->
            <p>"Little orphan Heidi goes to live high in the Alps with her gruff grandfather and brings happiness to all who know her on the mountain. When Heidi goes to Frankfurt to work in a wealthy household, she dreams of returning to the mountains and meadows, her friend Peter, and her beloved grandfather."</p>
        ...
        <div class="details">
            <div class="bordered-container">
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Author:</span><span> Johanna Spyri</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Manufacturer:</span><span> Kingfisher</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Lanuage: </span><span>English</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;"> ISBN code:</span><span> 0753454947</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Cover type:</span><span> Hard</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Publication date:</span><span> November 15, 2002</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Print length:</span><span> 352</span></h6>
            </div>
            ...
            <div class="bordered-container3">
                <h6><span style="font-weight: bold;">Register</span> and get 10% discount!</h6>
                <h6>Discount for full-price items. Discounts do not sum up!</h6>
                <h6>Order processing takes place on business days from 10AM to 6PM</h6>
