    ...
    <div class="container">
        ...
        <div class="details">
            <div class="bordered-container">
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Author:</span><span> ${book.author}</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Manufacturer:</span><span> ${book.manufacturer}</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Language: </span><span>${book.language}</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">ISBN code:</span><span> ${book.isbn}</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Cover type:</span><span> ${book.coverType}</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Publication date:</span><span> ${book.publicationDate}</span></h6>
                <h6><span style="color: #B8B6B5 ; font-weight: lighter;">Print length:</span><span> ${book.pageLength}</span></h6>
            </div>
